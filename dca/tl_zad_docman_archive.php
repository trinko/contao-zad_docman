...
//    'editing'                       => 'template,showTemplates',
  ...
  'fields' => array(
    ...
    'notifyText' => array(
      ...
      'load_callback' => array(
        array('tl_zad_docman_archive', 'convertAbsoluteLinks')
      ),
      'save_callback' => array(
        array('tl_zad_docman_archive', 'convertRelativeLinks')
      ),
      'sql'                         => "text NULL"
    ),
    'active' => array(
...
class tl_zad_docman_archive extends Backend {
   ...
   *
   * @param string $content  Text field with URL to convert
   *
   * @return string  The text field with URL to converted
   */
  public function convertAbsoluteLinks($content) {
    return str_replace('src="' .Environment::get('base'), 'src="', $content);
  }
   ...
   * @return string  The text field with URL to converted
   */
  public function convertRelativeLinks($content) {
    return $this->convertRelativeUrls($content);
  }
